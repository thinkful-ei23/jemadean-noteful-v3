...
describe('Noteful API - Folders', function () {
  ...
  describe('GET /api/folders', function () {
    ...
    it('should return a list with the correct keys', function () {
      return Promise.all([
  ...
  describe('GET /api/folders/:id', function () {
    ...
    it('should respond with status 404 and an error message when `id` is not valid', function () {
  ...
  describe('POST /api/folders', function () {
    ...
    it('should return an error when duplicating a name value', function () {
      const newFolder = {
        'name': 'Archive'
      };
      return chai.request(app)
